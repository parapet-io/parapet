...
/** Parapet's effect type.
  ...
  *
  * Programs are interpreted by a [[ParIORuntime]], which supplies the actual thread pools and the [[Effect]] /
  * [[Parallel]] instances used by the parapet runtime.
  */
...
/** [[ParIO]] constructors and the default runtime-backed type-class instances required by parapet. */
object ParIO:
