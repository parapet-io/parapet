 ...
 *
 * @param submitterId logical id of the fiber that enqueued this event.
 * @param seqNumber globally unique across a run (across all submitters and receivers). This makes every
 *   event uniquely identifiable.
 */
