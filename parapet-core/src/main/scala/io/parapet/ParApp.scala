...
/** Bootstraps a parapet application on top of an arbitrary effect type `F[_]`.
  ...
  * logic.
  *
  * Concrete effect implementations are exposed by backend modules. Users targeting an effect type provide the
  * [[effectInstance]] / [[parallelInstance]] capabilities, the scheduler runtime capability, and an [[unsafeRun]] entry
  * point.
  *
  * @tparam F
